...
export default class PostPro
{
    ...
    {
        this.scene = scene;
        this.width = this.scene.width * this.scene.resolution;
        this.height = this.scene.height * this.scene.resolution;
        ...
        this.blurX = new ShaderPass(this.scene.renderer, this.shaderBlur, this.width, this.height);
        this.blurY = new ShaderPass(this.scene.renderer, this.shaderBlur, this.width, this.height);
        ...
        this.pass = new ShaderPass(this.scene.renderer, this.finalShader, this.width, this.height);
    }
    render()
    {
        this.scene.renderer.render(this.scene.scene, this.scene.camera, this.normalColors);
        this.scene.bloomScene();
        this.scene.renderer.render(this.scene.scene, this.scene.camera, this.bloomColors);
